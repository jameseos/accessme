...
### CLAUSE NAME: Scope
By interacting with the contract or using the contract data binds you to the terms of this contract, and the contract specific to the createnugget action.
